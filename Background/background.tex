...
\mycitet{Sarrar12} present a library which exposes an \of-based FIB abstraction
...
network management. \mycitet{Foster11} present Frenetic, a declarative
...
utilisation in comparison to the ECMP~\mycitet{RFC2992} network load-balancing
...
computing resources for running large-scale experiments for free.  \mycitet{Erickson11}
