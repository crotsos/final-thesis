...
% This is the sole standardised instantiation of the SDN paradigm and version
% 1.0 is the current standard available in hardware switches.  \of functionality
% is modular, thus the experiments can be reproducible over other future SDN
...
% The platform provides to the users appropriate hooks to
% express their network control architecture and topology and the performance
% profile of the switching fabric, in order to understand the performance impact
...
The NS3 programming abastraction has a significant difference from available
