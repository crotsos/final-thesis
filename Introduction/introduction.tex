...
% range of network technologies~\cite{itufacts2011}, while Internet resources,
% based on estimations, generate 3.4\% of the global GDP~\cite{duRausas:2011un}.
...
% Computer networking is the mechanism enabling two computers to exchange data
% over a physical medium. 
...
\begin{figure}[] 
  ...
  \subfigure[global mobile Internet traffic trend]
...
The ideal mechanism for effective resource control requires a-priori knowldge of
...
% \todo{change pitch of this sentence} 
