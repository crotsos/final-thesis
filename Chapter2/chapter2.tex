...
Furthermore, home Internet connectivity has variable performance, depending on
ISP network policy.
...
%   \includegraphics[width=0.49\columnwidth]{throughput}
 ...
 \subfigure[homework packet throughput up to 50k concurrent flows]{
  ...
  \caption{\label{f:performance}Switching performance of \ovs component
    of our home router showing increasing median per-packet latency (LHS) and
    decreasing median packet throughput (RHS) with the number of flows.  The upper set
    of graphs
