...
NOX~\mycite{nox} control platform, an event-driven programmable controller with
...
(1500B) for the latency tests and minimal packets (70B)\footnote{The 30B extra
  overhead is due to \emph{pktgen}~\mycite{olsson05:_linux_packet_gener}, the
...
FlowVisor~\mycite{flowvisor-osdi}, while each home router runs an \of controller,
...
We expose resource control of our system to home member through a web interface,
...
Using the aforementioned topology, we evaluate the impact of our architecture on
